...
import com.smaple.vo.SampleFile;
...
//   FileDownlaodServlet의 service(HttpServletRequest request, HttpServletResponse response)
//   메소드를 실행해서 클라이언트의 요청을 처리한다.
// * @WebServlet은 서블릿에 대한 설정정보를 저장할 때 사용되는 어노테이션이다.
// * urlPatterns는 어떤 요청URL이 왔을 때 이 서블릿을 사용해야ㅐ 되는지를 지정한다.
