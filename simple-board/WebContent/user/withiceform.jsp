 			...
 			<form id="user-form" method="post" action="register.jsp" onsubmit="checkField(event)">
 				<div class="form-group">
 					<table class="table table-bordered">
 						<tbody>
 							<tr>
 								<th style="width: 18%;">회원구분 <img src="circle-16.png" width="5px;" height="5px;"/></th> 						
 				...
 				<h3>기본정보</h3>
 				<p style="text-align: right;"><img src="circle-16.png" width="5px;" height="5px;"/> 필수입력사항</p>
 				<table class="table table-bordered">
 					<tbody>
 						<tr>
 							<th class="">아이디 <img src="circle-16.png" width="5px;" height="5px;"/></th>
 							<td><input type="text" name="userid" id="textbox" /> (영문소문자/숫자,4~16자)</td>
 						</tr>
 						<tr>
 							<th>비밀번호 <img src="circle-16.png" width="5px;" height="5px;"/></th>
 							<td><input type="password" name="pwd" id="textbox"/> (영문 대소문자/숫자/특수문자 중 2가지 이상 조합, 10자~16자)</td>
 						</tr>
 						<tr>
 							<th>비밀번호 확인 <img src="circle-16.png" width="5px;" height="5px;"/></th>
 							<td><input type="password" name="pwdcheck" id="textbox"/></td>
 						</tr>
 						<tr>
 							<th>주소 <img src="circle-16.png" width="5px;" height="5px;"/></th>
 					...
 					<tr>
 						<th>휴대전화 <img src="circle-16.png" width="5px;" height="5px;"/></th>
 					...
 					<tr>
 						<th>SMS 수신여부 <img src="circle-16.png" width="5px;" height="5px;"/></th>
 						<td><input type="checkbox" name="sms" /> 동의함
 						<p>쇼핑몰에서 제공하는 유익한 이벤트 소식을 SMS로 받으실 수 있습니다.</p>
 						</td>
 					</tr>
 					<tr>
 						<th>이메일 <img src="circle-16.png" width="5px;" height="5px;"/></th>
				...
				<!-- -------------------------------------------------------------- -->	
 				...
 				<div class="form-group">
 					<table class="table table-bordered">
 						<tr>
 							<th>성별 <img src="circle-16.png" width="5px;" height="5px;"/></th>
 							<td>
 						...
 						<tr>
 							<th>생년월일 <img src="circle-16.png" width="5px;" height="5px;"/></th>
 							<td>
 						...
 						<tr>
 							<th>지역 <img src="circle-16.png" width="5px;" height="5px;"/></th>
 							<td>
 				...
 				<div class="row">
 					<div class="col-6">
 						<h3>이용약관 동의</h3>
 							...
 							<textarea name="agreearea" id="" cols="70" rows="8">
제1조(목적)
...
부 칙(시행일) 이 약관은 2016년 4월 1일부터 시행합니다.</textarea>
 							<p>이용약관에 동의하십니까?</p>
 							<input type="checkbox" name="agreecheck" /> 동의함
 						</div>
 					</div>
 					<div class="col-6">
 					<h3>개인정보 수집 및 이용 동의</h3>
 						<div class="privacy-area">
 								<textarea name="privacyarea" id="" cols="70" rows="8">
1. 개인정보 수집목적 및 이용목적
...
※ 동의를 거부할 수 있으나 거부시 회원 가입이 불가능합니다.
 							...
 							<input type="checkbox" name="privacycheck" /> 동의함
 						</div>
 					</div>
 				</div>
 				<p></p>
 					<div class="text-center">
 						<a href="register.jsp" onclick="" class="btn btn-dark btn-lg">회원가입</a>
...
<script type="text/javascript">
	function checkField() {
		...
		var pwdCheckField = document.querySelector("input[name=pwdcheck]");
		var tel2Field = document.querySelector("input[name=tel2]");
		var tel3Field = document.querySelector("input[name=tel3]");
		var cell2Field = document.querySelector("input[name=cel2]");
		var cell3Field = document.querySelector("input[name=cel3]");
		var smsField = document.querySelector("input[name=sms]");
		var emailField = document.querySelector("input[name=email]");
		var genderField = document.querySelector("input[name=gender]");
		var birthYearField = document.querySelector("input[name=birthyear]");
		var emailField = document.querySelector("input[name=email]");
