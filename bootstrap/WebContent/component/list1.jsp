	...
	<div class="row">
		...
		<div class="col-4">
			...
			<ul class="list-group">
				...
				<a class="list-group-item list-group-item" href="money.jsp">총무부</a>
				<a class="list-group-item list-group-item" href="mgr.jsp">관리부</a>
				<a class="list-group-item list-group-item" href="sales.jsp">영업부</a>
				<a class="list-group-item list-group-item" href="tech.jsp">기술부</a>
			</ul>
		</div>
	</div>
	<div class="row">
